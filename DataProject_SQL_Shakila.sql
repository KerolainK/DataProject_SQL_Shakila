...
SELECT VARIANCE(replacement_cost) AS variabilidad_coste_reemplazo
FROM film;
...
-- clasificación de la tabla film y muestra la clasificación junto con el promedio.
...
-- Respuesta:
-- No aporta un valor analítico directo, ya que genera todas las combinaciones
-- posibles entre películas y categorías, aunque no exista una relación real
-- entre ellas.
